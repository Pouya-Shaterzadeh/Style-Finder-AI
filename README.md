...
2. **Qwen 3.6 27B** analyzes the image — detects clothing items, colors, patterns, materials, fit, gender, and overall style. Returns structured JSON in a single API call.
...
| Layer | Model / Tool |
|---|---|
| Vision Language Model | Qwen 3.6 27B (qwen/qwen3.6-27b) |
